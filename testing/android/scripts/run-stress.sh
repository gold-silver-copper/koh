...
TESTS="stress-bind-storm stress-connection-churn stress-concurrent-clients stress-auth-ratelimit stress-signal-storm stress-throughput stress-memory-longevity stress-reconnect-restart stress-client-freeze stress-reattach-continuity stress-client-signals stress-netem stress-roaming stress-relay-discovery"
total=0
failed=0
failed_names=""
for t in $TESTS; do
