...
TESTS="stress-bind-storm stress-connection-churn stress-concurrent-clients stress-auth-ratelimit stress-signal-storm stress-throughput stress-memory-longevity stress-reconnect-restart"
total=0
failed=0
failed_names=""
for t in $TESTS; do
