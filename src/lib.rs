...
//! and unchecked arithmetic for the library, the binary and the tests, and a `forbid` cannot be
//! lifted by a local `#[allow]` or `#[expect]`. Tests may panic (see `clippy.toml`).
//!
